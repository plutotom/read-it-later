...
export const addArticleShape = {
    url: z
        ...
        .url()
        .optional()
        .describe("The URL of a page to save. The page is fetched and parsed automatically. Provide either a url, OR title + content for a manual entry — not both."),
    title: z
        .string()
        .optional()
        .describe("Title for a manual text entry. Required when there is no url. Use a concise, descriptive title — not a vague email subject line verbatim."),
...
export const searchArticlesShape = {
    query: z
        .string()
        .optional()
        .describe("Optional free-text query to search titles and content. Omit to list the most recently saved articles."),
    limit: z
        .number()
        .int()
        .optional()
    ...
    includeArchived: z
        .boolean()
        .optional()
        .describe("Whether to include archived articles. Defaults to false (only the active, non-archived inbox). Set true ONLY when the user explicitly asks for archived items."),
};
// ---- get_article_content --------------------------------------------------
...
export const updateArticleShape = {
    ...
    tags: z
        .array(z.string())
        .optional()
        .describe("The complete set of tags for the article. REPLACES existing tags, so include any current tags you want to keep. Omit to leave tags unchanged."),
