...
- [ ] All proposed code changes maintain TypeScript type safety
- [ ] No `any` types introduced without explicit justification
- [ ] Type definitions align with existing patterns

### Documentation Requirements

- [ ] Context7 MCP consulted for any unfamiliar technologies
- [ ] Memory notes created for repeated patterns
- [ ] Complex business logic documented with clear comments

### Tech Stack Alignment

- [ ] All new dependencies align with T3 Stack (Next.js, React, TypeScript, Tailwind, Drizzle, tRPC, betterAuth)
- [ ] Database changes use Drizzle ORM patterns
- [ ] API endpoints use tRPC procedures
- [ ] UI components use shadcn/ui patterns

### No Testing Policy

- [ ] No test files, test runners, or testing frameworks proposed
- [ ] Type safety through TypeScript provides sufficient validation
- [ ] Focus on implementation and type refinement
